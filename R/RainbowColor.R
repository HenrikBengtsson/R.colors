#########################################################################/**
# @RdocClass RainbowColor
#
# @title "Class representing rainbow colors"
#
# \description{
#  @classhierarchy
#
...
#
# \arguments{
#   \item{rainbow}{@vector of rainbow levels in the range [0,\code{maxColorValue}] 
...
# }
#*/#########################################################################
setConstructorS3("RainbowColor", function(rainbow=NULL, ...) {
  extend(OneDimensionalColor(rainbow=rainbow, ...), "RainbowColor")
})

setMethodS3("getColors", "RainbowColor", function(this, filter=TRUE, ncolors=65535, ...) {
  # Get colors
